...
RUN bash -l -c 'bash ~/.profile && bash /glue/bin/glue-setup.sh && wget -O /glue/conf/log4j.properties https://gist.githubusercontent.com/svajiraya/aecb45c038e7bba86429646a68b542bb/raw/0cc6229d3b745a0092be75bbbf9476fa17318004/log4j.properties && pip2 install pytest boto3'

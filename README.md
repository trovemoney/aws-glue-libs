...
This repo is based off of a fork from the official aws-glue-libs repo. The fork provided tooling for a docker container too easily be built.

We have since modified the repo to be compatible with github actions, so that we can test glue scripts.
